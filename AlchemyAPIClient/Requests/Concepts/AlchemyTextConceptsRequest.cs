...
{
    public class AlchemyTextConceptsRequest : AlchemyConceptsRequestBase, IAlchemyAPITextRequest, ICombinableAlchemyAPIRequest, IAlchemyAPITextCombinableRequest
    {
